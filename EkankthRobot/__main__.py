...
import EkankthRobot.modules.sql.users_sql as sql
...
from EkankthRobot.modules import ALL_MODULES
from EkankthRobot.modules.helper_funcs.chat_status import is_user_admin
from EkankthRobot.modules.helper_funcs.misc import paginate_modules
...
๏𝙼𝚄𝚂𝙸𝙲 𝙿𝙻𝙰𝚈 𝙵𝙴𝙰𝚃𝚄𝚁𝙴𝚂
๏𝚅𝙸𝚂𝙸 @ANSH\_HU 𝙵𝙾𝚁 𝙼𝙾𝚁𝙴...
๏───────────────────────๏

⏤͟͟͞͞•𓊈𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 @I\_LOVE\_YOU\_MY\_HEARTBEET 𓊉
...
buttons = [
    [
        InlineKeyboardButton(
            text="★ 𝐀𝐝𝐝 𝐌𝐞 𝐌𝐨𝐢 𝐋𝐮𝐯 ★ ",
            url=f"https://t.me/ANSH_MANAGMENTBOT?startgroup=true",
        ),
    ],
    [
        InlineKeyboardButton(text="🍁𝐆𝐑𝐎𝐔𝐏🍁", url=f"https://t.me/ISHQ00_I"),
        InlineKeyboardButton(text="⚙️𝐇𝐄𝐋𝐏⚙️", callback_data="help_back"),
    ],
    [
        
        InlineKeyboardButton(text="🌷𝐎𝐰𝐧𝐞𝐫🌷", url=f"https://t.me/I_LOVE_YOU_MY_HEARTBEET"),
        InlineKeyboardButton(text="🥀𝐎𝐅𝐅𝐈𝐂𝐄🥀", url=f"https://t.me/Y_K_D_1"),
    ],
    [
        InlineKeyboardButton(
            text="🌱𝐒𝐎𝐔𝐑𝐂𝐄🌱",
      url=f"https://t.me/ISHQ00_I",
        ),
    ],
]
...
║
║┏━━━━━━➣
║┣⪼ 𝙾𝚆𝙽𝙴𝚁 ➪ @I\_LOVE\_YOU\_MY\_HEARTBEET
║┣⪼ 𝙶𝚁𝙾𝚄𝙿 ➪ @ISHQ00\_I
║┣⪼ 𝙾𝙵𝙵𝙸𝙲𝙴 ➪ @Y\_K\_D\_1
║┗━━━━━━➣
║
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ",
                            callback_data="https://github.com/CuteBaccha/CuteBacchabot",
                        ),
                    ],
                    [
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://github.com/TheAnonymous2005/FallenRobot)
